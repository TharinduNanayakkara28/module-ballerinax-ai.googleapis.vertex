...
/**
 * Native shim for the streaming response generation of a Vertex AI model provider.
 *
...
public class StreamGenerator {
    public static Object generateStream(Environment env, BObject modelProvider,
        ...
        return env.getRuntime().callFunction(
                new Module("ballerinax", "ai.googleapis.vertex", "1"), "generateLlmResponseStream", null,
